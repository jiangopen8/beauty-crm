...
files.forEach(file => {
    try {
        ...
        if (content.includes(oldPattern)) {
            ...
            console.log(`[OK] ${file} - 成功更新`);
            successCount++;
        } else {
            console.log(`[SKIP] ${file} - 未找到匹配内容`);
            skipCount++;
        }
    } catch (error) {
...
console.log('='.repeat(60));
console.log(`更新完成! 成功: ${successCount}, 跳过: ${skipCount}, 失败: ${failCount}`);
